def numero_a_letra(monto: float) -> str:
    ...
    entero = int(monto); cents = round((monto-entero)*100)
    if entero==0: letra="CERO"
    elif entero<1_000_000: letra=_m(entero)
    else:
        mm=entero//1_000_000; r=entero%1_000_000
